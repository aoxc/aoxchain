...
The generated fixture should therefore carry explicit `testnet-` naming in validator-facing artifacts while still emitting reproducible genesis, host, node, and manifest files for operator auditability.
