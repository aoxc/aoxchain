# Integration Tests - Production Audit Guide

**Current Documentation Version:** `aoxc.v.0.1.0-testnet.1`
**Cargo-Compatible Release Version:** `0.1.0-testnet.1`

## Executive Summary
Cross-workspace verification documentation.

## What This Directory Contains
The tests workspace crate contains end-to-end and integration-level flows that validate interactions spanning multiple crates.

### Key Files and Subsystems
- `tests/src/lib.rs`
- `tests/src/contract_native_flow.rs`
...
- Validate whole-system behavior beyond unit boundaries.
- Provide release evidence for integration workflows.
- Capture regressions that only appear when multiple crates interact.

## Security Boundary and Audit Focus
Integration tests are a major control against unsafe assumptions between crates and binaries.
