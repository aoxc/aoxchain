# Integration Tests - Audit Roadmap

**System Version Baseline:** `aoxc.v.0.1.1-akdeniz`

Cross-workspace verification roadmap for end-to-end and adversarial evidence.
...
- `aoxc.v.0.1.1-akdeniz+production-readiness-tests`: added non-node regression coverage for transaction payload bounds, signature-sensitive root derivation, finalized-consensus stale-vote rejection, and chaos-harness integrity preservation.
