...
- `aoxc.v.0.1.1-akdeniz`: extended the same closure bundle to emit `security-drill.json` and `desktop-wallet-compat.json` for pentest-style drill evidence and desktop wallet hub compatibility.
