...
Environment-level overlays are available under `configs/environments/*/topology/` to allow explicit per-network activation profiles without mutating the global templates.
