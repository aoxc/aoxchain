...
- `READ.md` ve `TESTING.md` üretim kapanış zorunluluklarının açık olduğunu net yazıyor.
...
2. `READ.md` ve `TESTING.md` içinde tanımlı release blocker niteliğindeki zorunlulukları kapatmak.
