...
- `ADVANCED_NODE_ROLE_BLUEPRINT.md` — full role/layer/plane topology with policy-gated activation, AOXC-Q consensus phases, and quantum-role expansion guidance.
