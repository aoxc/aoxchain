# Risk & Governance Models - Production Audit Guide

**Current Documentation Version:** `aoxc.v.0.0.0-alpha.2`
**Cargo-Compatible Release Version:** `0.0.0-alpha.2`

## Executive Summary
Risk model lifecycle documentation.

## What This Directory Contains
The models directory stores structured YAML definitions used for validator risk and operational governance analysis.

### Key Files and Subsystems
- `models/validator-risk-v1.yaml`
- `models/sample.yaml`
...
- Document machine-readable governance expectations.
- Keep compatibility metadata aligned with node releases.
- Provide inputs for policy and readiness evaluation.

## Security Boundary and Audit Focus
Risk models must not silently drift away from the deployed software baseline.
