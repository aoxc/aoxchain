# Risk & Governance Models - Version Governance

**Current Version:** `aoxc.v.0.1.0-testnet.1`
**Previous Version:** `aoxc.v.0.0.0-alpha.2`
...
## Version Ledger
- `aoxc.v.0.1.0-testnet.1`: documentation expanded to a full audit guide, strict version governance introduced for this directory, and the release baseline advanced to alpha.3.
- `aoxc.v.0.0.0-alpha.2`: full audit-guide and directory-level version tracking baseline introduced.
