# AOXCMD - Production Audit Guide

**Current Documentation Version:** `aoxc.v.0.0.0-alpha.2`
**Cargo-Compatible Release Version:** `0.0.0-alpha.2`

## Executive Summary
Binary, CLI, and operational orchestration documentation.

## What This Directory Contains
AOXCMD is the node and operator command-line surface. It wires configuration, runtime initialization, services, keys, telemetry, AI operators, and node lifecycle commands into executable workflows.
...
- Expose a deterministic and auditable node-control interface.
- Keep bootstrap, runtime, and shutdown paths explicit.
- Protect operators from accidental unsafe defaults.

## Security Boundary and Audit Focus
This folder must be reviewed for dangerous defaults, incomplete input validation, and secrets exposure in logs, environment handling, and bootstrap flows.
