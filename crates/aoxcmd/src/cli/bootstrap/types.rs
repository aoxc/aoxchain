...
pub(super) struct AddressCreateOutput {
    ...
    pub(super) validator_account_id_mode: String,
    pub(super) validator_account_id_legacy: String,
    pub(super) account_id_checksum: String,
    pub(super) account_id_derivation_domain: String,
    pub(super) account_id_payload_hex_chars: usize,
    pub(super) account_id_salt_applied: bool,
