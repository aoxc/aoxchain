# AOXCAI - Production Audit Guide

**Current Documentation Version:** `aoxc.v.0.1.0-testnet.1`
**Cargo-Compatible Release Version:** `0.1.0-testnet.1`

## Executive Summary
AI extension governance and assurance documentation.

## What This Directory Contains
AOXCAI models AI manifests, capability controls, constitutions, audit sinks, and remote backend integration used for advisory workflows.
...
- Keep AI authorization explicit and reviewable.
- Track compatibility and backend policy boundaries.
- Provide audit-grade evidence for AI-assisted actions.

## Security Boundary and Audit Focus
Remote model invocation, policy fusion, and compatibility enforcement require careful review.
