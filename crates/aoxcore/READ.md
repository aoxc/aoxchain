# AOXCORE - Production Audit Guide

**Current Documentation Version:** `aoxc.v.0.0.0-alpha.2`
**Cargo-Compatible Release Version:** `0.0.0-alpha.2`

## Executive Summary
Core protocol model and state integrity documentation.

## What This Directory Contains
AOXCORE defines the primary blockchain domain models: blocks, transactions, genesis, identity, contract records, receipts, mempool semantics, and state primitives.
...
- Maintain canonical protocol data structures.
- Preserve deterministic hashing and identity semantics.
- Provide the source-of-truth models consumed by higher-layer crates.

## Security Boundary and Audit Focus
Security review focuses on serialization stability, arithmetic safety, identity correctness, and preventing ambiguous state interpretation between nodes.
