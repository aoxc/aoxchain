...
- future profile rollout is mediated by explicit forward-compatibility checks
  (`is_forward_compatible_with`) so new PQ sets can be adopted without reopening
  hybrid/legacy policy paths.
