# AOXCMOB - Production Audit Guide

**Current Documentation Version:** `aoxc.v.0.0.0-alpha.3`
**Cargo-Compatible Release Version:** `0.0.0-alpha.3`

## Executive Summary
Mobile edge transport and secure device operations documentation.

## What This Directory Contains
AOXCMOB provides secure signer, keystore, session, gateway, and transport abstractions for mobile/edge participation.
...
- Protect device-side key material.
- Keep session flows and signing boundaries explicit.
- Support safe gateway integration from constrained devices.

## Security Boundary and Audit Focus
Key exposure, insecure session establishment, and transport tampering are the primary risks.
