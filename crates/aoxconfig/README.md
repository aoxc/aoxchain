...
- The same policy surface can now produce `aoxcore::genesis::QuantumPolicy` and `aoxcore::native_token::NativeTokenQuantumPolicyV1`, keeping config, genesis, and ledger quantum assumptions aligned.
