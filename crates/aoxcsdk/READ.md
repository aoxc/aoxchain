...
- `aoxc.v.0.1.2-akdeniz-sdk`: expanded SDK manifest builder surface with preset constructors, policy/schema tuning knobs, descriptor build helper, default metadata generation, and unit tests for builder reliability.
