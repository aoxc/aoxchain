...
## Executive Summary
AOXCLIBS provides shared low-level types and utility helpers used by multiple crates.
...
## Main Code Areas
- `encoding.rs`, `time.rs`, and `types.rs`: shared primitives and convenience layers.

## Security and Audit Focus
Small utility crates can create large blast radii, so compatibility and deterministic behavior are essential.
