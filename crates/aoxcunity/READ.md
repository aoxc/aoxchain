# AOXCUNITY - Production Audit Guide

**Current Documentation Version:** `aoxc.v.0.0.0-alpha.2`
**Cargo-Compatible Release Version:** `0.0.0-alpha.2`

## Executive Summary
Consensus safety, finality, and adversarial resilience documentation.

## What This Directory Contains
AOXCUNITY implements validator rotation, quorum rules, block admission, safety checks, vote handling, finality, recovery, and consensus kernel transitions.
...
- Keep consensus transitions deterministic.
- Reject equivocation, stale votes, and invalid ancestry.
- Provide auditable evidence that finality and pruning remain safe under hostile inputs.

## Security Boundary and Audit Focus
Consensus correctness is a high-stakes surface. Reviews should emphasize quorum accounting, branch pruning, replay resistance, and round/height monotonicity.
