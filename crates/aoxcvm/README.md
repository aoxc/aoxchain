...
- Delivery model: **Three-phase kernel-to-quantum execution program**
...
- `docs/PHASE3_RELEASE_CLOSURE.md`: release closure requirements and operational evidence posture.
