...
- `aoxc.v.0.0.0-alpha.1+resilience.campaign`: expanded the resilience harness with deterministic partition simulation, scenario campaigns, peer remediation scorecards, and enforcement-ready audit evidence for quarantine or ban workflows.
