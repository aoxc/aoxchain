# AOXCNET - Production Audit Guide

**Current Documentation Version:** `aoxc.v.0.0.0-alpha.3`
**Cargo-Compatible Release Version:** `0.0.0-alpha.3`

## Executive Summary
Networking, gossip, and transport assurance documentation.

## What This Directory Contains
AOXCNET owns peer discovery, gossip, transport primitives, network configuration, and port mapping.
...
- Bound network-facing input surfaces.
- Preserve deterministic peer-handling expectations.
- Expose network controls required for audit and operations.

## Security Boundary and Audit Focus
Peer trust, message admission, and denial-of-service resistance are the main review themes.
