# AOXCONTRACT - Production Audit Guide

**Current Documentation Version:** `aoxc.v.0.1.0-testnet.1`
**Cargo-Compatible Release Version:** `0.1.0-testnet.1`

## Executive Summary
Contract manifest governance documentation.

## What This Directory Contains
AOXCONTRACT defines canonical contract manifest, artifact, policy, and compatibility models.
...
- Keep contract metadata deterministic and reviewable.
- Enforce compatibility and policy controls.
- Support manifest validation and fixture-based regression checks.

## Security Boundary and Audit Focus
Manifest spoofing, incompatible artifact declarations, and policy bypass are the core audit concerns.
