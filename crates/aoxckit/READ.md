# AOXCKIT - Production Audit Guide

**Current Documentation Version:** `aoxc.v.0.1.0-testnet.1`
**Cargo-Compatible Release Version:** `0.1.0-testnet.1`

## Executive Summary
Cryptographic tooling and identity operations documentation.

## What This Directory Contains
AOXCKIT supplies command-line cryptographic workflows for keys, certificates, revocation, registry, and actor identity tooling.
...
- Provide secure operator tooling for identity lifecycle tasks.
- Keep outputs deterministic and auditable.
- Avoid unsafe automation around cryptographic material.

## Security Boundary and Audit Focus
Identity material handling and operator UX safety are the primary review concerns.
