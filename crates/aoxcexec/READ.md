# AOXCEXEC - Production Audit Guide

**Current Documentation Version:** `aoxc.v.0.1.0-testnet.1`
**Cargo-Compatible Release Version:** `0.1.0-testnet.1`

## Executive Summary
Execution coordination documentation.

## What This Directory Contains
AOXCEXEC exposes execution coordination types used by runtimes and host integration layers.
...
- Act as a narrow, deterministic coordination surface.
- Keep execution contracts simple and auditable.
- Support compatibility between runtimes and execution services.

## Security Boundary and Audit Focus
The surface is small, but interface drift and hidden assumptions can create systemic execution faults.
