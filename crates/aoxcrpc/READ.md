# AOXCRPC - Production Audit Guide

**Current Documentation Version:** `aoxc.v.0.0.0-alpha.2`
**Cargo-Compatible Release Version:** `0.0.0-alpha.2`

## Executive Summary
RPC gateway security and API reliability documentation.

## What This Directory Contains
AOXCRPC provides HTTP, gRPC, and WebSocket services with middleware for rate limiting, mTLS, and validation.
...
- Translate internal models into stable client-facing APIs.
- Protect query and write paths with middleware and validation.
- Provide operator-visible metrics and health signals.

## Security Boundary and Audit Focus
API authentication, rate limiting, schema validation, and request-bounding are mandatory review areas.
