# AOXCDATA - Production Audit Guide

**Current Documentation Version:** `aoxc.v.0.1.0-testnet.1`
**Cargo-Compatible Release Version:** `0.1.0-testnet.1`

## Executive Summary
State persistence and storage integrity documentation.

## What This Directory Contains
AOXCDATA manages state-tree, key-value, and contract storage abstractions used by higher layers.
...
- Preserve deterministic persistence behavior.
- Keep storage schema transitions reviewable.
- Support recovery and integrity verification.

## Security Boundary and Audit Focus
Storage corruption, schema drift, and unbounded persistence operations are the main risks.
